...
public class FwMethodValidator {

    private final List<Throwable> fErrors = new ArrayList<Throwable>();

    private TestClass fTestClass;

    public FwMethodValidator(TestClass testClass) {
        fTestClass = testClass;
    }

    public void validateInstanceMethods() {
        validateBeforeAfterMethods(After.class, false);
        validateBeforeAfterMethods(Before.class, false);
...
//                        + " should have no parameters"));
    ...
    private void validateBeforeAfterMethods(Class<? extends Annotation> annotation,
            boolean isStatic) {
        List<Method> methods = fTestClass.getAnnotatedMethods(annotation);
